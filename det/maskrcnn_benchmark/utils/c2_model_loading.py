...
def _rename_basic_resnet_weights(layer_keys):
    ...
    layer_keys = [k.replace("rpn.bbox.pred", "rpn.bbox_pred") for k in
                  layer_keys]
    layer_keys = [k.replace("rpn.cls.logits", "rpn.cls_logits") for k in
                  layer_keys]
    ...
    layer_keys = [k.replace(".branch1_bn.", ".downsample.1.") for k in
                  layer_keys]
